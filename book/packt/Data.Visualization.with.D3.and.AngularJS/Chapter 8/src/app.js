...
.controller('MainCtrl', ["$scope", "d3", "SimpleHttpLoader", "StringParser", "Classifier",
  function ($scope, d3, SimpleHttpLoader, StringParser, Classifier) {
    ...
    $scope.startDate  = '2014-11-26T12:00:00+0100';
    $scope.endDate  = '2014-11-26T17:00:00+0100';
    ...
    // $scope.$watch('[startDate, startTime, endDate, endTime]', function (){
    //   $scope.startDateTime = $scope.startDate + 'T' + $scope.startTime + '+0100';
    //   $scope.endDateTime = $scope.endDate + 'T' + $scope.endTime + '+0100';
    // });
  }
]);